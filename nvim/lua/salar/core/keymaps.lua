...
-- codesnap
keymap.set("v", "<leader>cc", ":'<,'>CodeSnap<CR>", { desc = "Save code snapshot to clipboard" })
keymap.set("v", "<leader>cs", ":'<,'>CodeSnapSave /home/bosio/Pictures/nvim/snapshot.png<CR>", { desc = "Salva snapshot" })
